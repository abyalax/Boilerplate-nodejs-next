  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">Client Admin Orders</h1>
          <p className="text-muted-foreground">Manage your application settings and orders</p>
        </div>
      ...
      <Tabs defaultValue="users" className="space-y-4">
        <TabsList>
          <TabsTrigger value="users">Orders</TabsTrigger>
