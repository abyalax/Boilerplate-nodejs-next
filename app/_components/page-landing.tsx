      ...
      <header className="flex flex-col md:flex-row items-center justify-between gap-10 px-8 py-20 max-w-6xl mx-auto">
        <div className="flex-1 space-y-6">
          <H1 className="text-nowrap">
            Manage your Business with our{" "}
            <span className="text-[var(--brand)]">SaaS</span>
          </H1>
          <P className="max-w-md text-[var(--text-secondary)]">
            Multi-tenant app: Everyone can register, manage products, customers,
            and transactions isolation in one platform.
          </P>
          <Flex gap={4} className="flex-wrap">
            <Button
              size="lg"
              className="bg-[var(--brand)] text-[var(--brand-contrast)]"
            >
              Get Started
            </Button>
      ...
      <main className="px-8 py-20 max-w-6xl mx-auto grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
        <Card>
          <CardContent className="p-6 space-y-3">
            ...
            <P className="text-[var(--text-secondary)]">
              Each has isolated data: products, customers, transactions are
              secure and private.
            </P>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-6 space-y-3">
            ...
            <P className="text-[var(--text-secondary)]">
              Register customers, track shopping history, and increase loyalty.
            </P>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-6 space-y-3">
            ...
            <P className="text-[var(--text-secondary)]">
              Upload products, manage stock, and synchronize multiple branches
              easily.
            </P>
          </CardContent>
        </Card>
