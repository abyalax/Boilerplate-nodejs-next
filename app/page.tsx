...
export const metadata: Metadata = {
  ...
  description:
    "Explore Abya's personal website showcasing development projects, technical blogs, and more.",
  ...
  openGraph: {
    title: "Abya's Profile",
    description:
      "Discover innovative web and software development projects by Abya.",
    url: env.BASE_URL,
  ...
  twitter: {
    ...
    title: "Abya's Profile",
    description:
      "Software engineer, web developer, and digital creator. Explore my work.",
    site: "@abya_dev",
    creator: "@abya_dev",
